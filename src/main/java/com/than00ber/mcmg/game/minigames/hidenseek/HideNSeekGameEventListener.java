...
//
//            for (Hider hider: GAME.HIDERS.keySet()) {
//                hider.increaseTimer(hidingTickThreshold);
//            }
//        }, 0, 1);
    }
...
//        for (Hider hider: GAME.HIDERS.keySet()) {
//            if (hider.getPlayer() == event.getPlayer()) {
//                hider.setHidingSpot(event.getPlayer().getLocation()).resetTimer();
//                return;
//            }
//        }
    }
...
//                hider.setHidingMaterial(block.getType()).resetTimer();
//                return;
//            }
//        }
    }
